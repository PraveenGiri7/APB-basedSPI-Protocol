...
REM
REM Generated by Vivado on Sun Jul 20 14:52:50 +0530 2025
...
echo "xvlog --incr --relax -prj baud_generator_tb_vlog.prj"
call xvlog  --incr --relax -prj baud_generator_tb_vlog.prj -log xvlog.log
