...
REM
REM Generated by Vivado on Fri Jul 18 14:15:55 +0530 2025
...
echo "xvlog --incr --relax -prj spi_slave_select_tb_vlog.prj"
call xvlog  --incr --relax -prj spi_slave_select_tb_vlog.prj -log xvlog.log
