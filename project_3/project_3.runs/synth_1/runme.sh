...
HD_PWD='C:/Users/RUPESH KUMAR GOSWAMI/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_slave_select.tcl
