...
HD_PWD='C:/Users/RUPESH KUMAR GOSWAMI/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_select.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_slave_select.tcl -notrace
