...
REM
REM Generated by Vivado on Fri Jul 18 06:57:41 +0530 2025
...
echo "xvlog --incr --relax -prj spi_core_tb_vlog.prj"
call xvlog  --incr --relax -prj spi_core_tb_vlog.prj -log xvlog.log
